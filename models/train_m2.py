...
'''
    ...
    encoder = MemoryAugmentedEncoder(3, 0, d_in=1024, attention_module=ScaledDotProductAttentionMemory,
                                     attention_module_kwargs={'m': args.m})
    decoder = MeshedDecoder(len(text_field.vocab), 130, 3, text_field.vocab.stoi['<pad>'])
